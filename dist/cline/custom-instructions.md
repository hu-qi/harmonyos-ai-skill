...
The following sections are generated from supporting files for AI tools that only accept a single instruction file. Native Agent Skill runtimes should use the directory version instead.
...
5. Permission and `module.json5` requirements.
6. UI rendering and list performance.
7. Build/signing/package implications.
...
struct TodoListPage {
  @State items: TodoItem[] = [
    ...
    new TodoItem('2', 'Use stable keys in LazyForEach')
  ];
